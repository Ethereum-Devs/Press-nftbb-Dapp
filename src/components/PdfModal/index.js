...
export const PdfModal = (props) => {
    ...
    const handleAudioPlay = () => {
        // setIsPlay(true)
        window.open("https://wippbooks.mypinata.cloud/ipfs/QmRq2cbGbtCJ5Vs4cnbkDAbY68nLmo1d5q4BQVdqjWTcDg/", "_blank")
    }
        ...
        <div className={styles.div}>
            ...
            <div className={styles.pdf}>
                <div className="_df_book" webgl="true" backgroundcolor="#C1C1C1" minwidth="auto"
                    source="https://wippbooks.mypinata.cloud/ipfs/bafybeigirmjbgh5d2x7o5sxz4qqxqkzy7ky3gtepb5iukdpcxzbqxewgti?accessToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpbmRleGVzIjpbIjMzMDcxM2VlMThjMjRjZjVkNDJjNmIwYWExMmIzMzE3Il0sImFjY291bnRJZCI6Ijc5ZjI3ZWZlLTg3M2QtNGE1OS05ZTYwLWI5ZDJlN2RmNTgwNCIsImlhdCI6MTY0MTMzMzYxNiwiZXhwIjoyNzkyMTU4ODkyOH0.xX1Anbq7IjoIKnDbF3scBFKXixhjTU7enM3CCRH-J0Q"
                >
                </div>
            </div>
